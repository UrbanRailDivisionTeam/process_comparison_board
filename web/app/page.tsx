...
import { useReactTable, getCoreRowModel, type ColumnFiltersState, type SortingState, type VisibilityState, type PaginationState } from "@tanstack/react-table"
    ...
    return (
        <div className="flex min-h-svh flex-col">
            ...
            <div className="flex flex-1 flex-col gap-4 p-6">
                ...
                {loading && <div className="flex h-48 items-center justify-center text-sm text-muted-foreground">加载中...</div>}
                ...
                {!loading && !error && <DataTable table={table} totalRows={rowCount} />}
            </div>
        </div>
    )
}
